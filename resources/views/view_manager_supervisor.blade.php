	...
	<div id="page-wrapper">
		<div class="header"> 
			<ol class="breadcrumb">
				...
				<li class="active">"supervisor name"</li>
			</ol> 
		</div>
		<div class="row">
			<div class="col-lg-6">
							...
							<table class="table">
								...
								<tbody>
									<tr>
										...
										<td></td>
										<td></td>
										<td><a href="view_manager_supervisor_executive" class="btn btn-primary btn-sm">view</a></td>
									</tr>
								</tbody>
							</table>   
						</div>
							...
							<div class="tab-pane fade" id="detailed">
								<div class="row">
    								...
    								<div class="col-lg-5">
    									...
    									</div><button type="button" class="btn btn-default btn-xs" >Export excel</button>
									</div>
								</div>
							</div>
						</div>
